namespace E_invoice1._2 {
	...
	public  class SellerPartyRecord {
		...
		private string transactionPartnerCodeField;
		...
		public string TransactionPartnerCode {
			get => this.transactionPartnerCodeField;
			set => this.transactionPartnerCodeField = value;
		}
